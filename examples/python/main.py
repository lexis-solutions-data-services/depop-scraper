"""
Example: How to call the depop-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/depop-scraper
...
def run_actor():
    """Run the depop-scraper actor and retrieve results."""
